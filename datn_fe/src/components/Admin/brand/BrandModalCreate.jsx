...
import { callCreateBrand, callUploadFile } from '../../../services/api';

const BrandModalCreate = ({ openModalCreate, setOpenModalCreate, fetchBrands }) => {
    ...
    const onFinish = async (values) => {
        ...
        setIsSubmit(true);
        try {
            const res = await callCreateBrand({ name, description, thumbnail });
            if (res && res.data) {
                ...
                throw new Error(res.message || 'Không thể tạo thương hiệu');
            }
        } catch (error) {
            notification.error({
